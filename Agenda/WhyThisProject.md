...
## the Agenda
Imagine i convinced my friend that my PC has Nvidia Dedicated GPU (1050 (4GB VRAM)) even though it is not. Now, my friend will want to verify so they will check task manager, dxdiag and settings. They will then want to find, open and verify the Nvidia Control Panel.
...
Future Enhancement: will show in task manager, dxdiag and settings on windows by which this project is already doing (can be enhanced)
...
5. open NvidiaControlPanel.exe (e.g., GTX 1050)
