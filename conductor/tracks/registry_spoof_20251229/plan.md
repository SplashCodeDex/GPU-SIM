...
- [x] Task: Update `SystemInfoView.xaml` [28a29d5]
...
- [x] Task: Update `SystemInfoViewModel.cs` [28a29d5]
...
- [x] Task: Conductor - User Manual Verification 'UI Integration (The Hidden Trigger)' (Protocol in workflow.md) [28a29d5]

## Phase 3: Final Verification
- [ ] Task: System-Wide Verification
    - [ ] Sub-task: Run the app, trigger the hidden spoof, and confirm the UAC prompt appears.
    - [ ] Sub-task: Open Windows Task Manager and verify the GPU name matches `gpu_config.json`.
    - [ ] Sub-task: Open Windows Display Settings and verify the VRAM matches `gpu_config.json`.
