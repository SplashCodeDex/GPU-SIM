...
class NvidiaControlPanel(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("C:\\Users\\NicoDex\\Downloads\\294666_nvidia_icon.ico"))  # Replace with actual path to your icon
        ...
        self.watermark = QPixmap("C:\\Users\\NicoDex\\Downloads\\Watermark.png")  # Replace with the actual path to your watermark image
    ...
    def paintEvent(self, event):
        ...
        painter.drawPixmap(self.rect(), self.watermark)  # Draw the watermark on the window
        painter.end()
